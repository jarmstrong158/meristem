...
- **Skills** (`skills/`, auto-discovered):
  ...
  - `pixel-art` — the sprite construction standard (hue-shifted ramps, the 13-archetype registry +
...
- **MCP server** (`.mcp.json`): `meristem-spec-store` — read tools, one validated write (`set_domain`),
  `scaffold_project`, `diff_domain`, `validate_all`, a spec-inspector UI panel (SEP-1865), and sprite
  discovery: `list_sprite_archetypes` (the pickable vocabulary) + `check_sprite` (validate one pick).
