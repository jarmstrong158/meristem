...
**Tradeoff/follow-ups:** arm swing in opposition (subtle at 32px), a passing pose distinct from idle, 8-direction variants, and cadence tied to move speed — all deferred polish; the core cycle is correct.
